...
<div class="container">
    ...
    <form action="/menu/{{ $data->id }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="harga" class="form-control" value="{{ $data->harga }}" name="harga" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="keterangan" class="form-control" value="{{ $data->keterangan }}" name="keterangan" required>
        </div>
